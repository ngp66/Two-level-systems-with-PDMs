...
When arrays of TLS with PDM are positioned near the maximum of the Rabi frequency, they can sustain coherence for much longer times than non-polar systems, allowing for better control and tunability of multi-emitter systems. 
